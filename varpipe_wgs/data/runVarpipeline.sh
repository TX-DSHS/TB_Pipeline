...
#make output dir
rm -rf /home/lab/tbCDC/reads/$1 /home/lab/tbCDC/varpipe_wgs/data/Output/$1.zip /home/lab/tbCDC/varpipe_wgs/data/Output/$1
rm -r /home/lab/tbCDC/reads/T*
rm -r /home/lab/tbCDC/varpipe_wgs/data/Output/*
project=$1
proj_dir=/home/lab/tbCDC/varpipe_wgs/data/Output/$1
mkdir -p $proj_dir

#get files from aws, create file links
aws s3 cp s3://804609861260-bioinformatics-infectious-disease/TB/RAW_RUNS/$1\.zip /home/lab/tbCDC/reads/$1\.zip --region us-gov-west-1
unzip /home/lab/tbCDC/reads/$1\.zip -d /home/lab/tbCDC/reads/
rm -rf /home/lab/tbCDC/reads/$1\.zip
